...
当前文档只保留安装、使用、架构和当前功能说明；历史阶段报告与一次性规划材料已从仓库移除。

| 文档 | 用途 |
| --- | --- |
| [README.md](../README.md) | 项目概览、桌面端启动与验证 |
| [QUICKSTART.md](QUICKSTART.md) | 快速配置与首轮运行 |
...
论文相关草稿保留在 [paper_plan/](paper_plan/)。它们是研究材料，不是产品使用文档。
