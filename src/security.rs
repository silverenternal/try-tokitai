...
pub fn default_tool_risk_map() -> &'static HashMap<String, RiskLevel> {
    ...
    MAP.get_or_init(|| {
        ...
        let safe_tools = [
            ...
            "git_branch", "git_remote", "code_search", "file_search",
            "find_function", "count_lines", "analyze_code", "code_analyze",
            "search_web", "wikipedia_search", "json_format", "json_query",
            "json_validate", "json_merge", "data_conversion", "list_processes",
            "process_info", "system_monitor", "check_tcp_port", "read_pdf_text",
            "read_pdf", "calc", "time_now", "get_weather",
            "project_list_templates", "observability_metrics", "observability_logs",
            "dialogue_summarize", "dialogue_context", "prompt_list", "prompt_get",
            "grep", "find_files", "fetch_url", "search_arxiv", "search_paper",
            "fetch_paper", "inspect_dataset", "sympy_simplify", "sympy_solve",
            "sympy_integrate", "sympy_diff", "sympy_matrix",
        ...
        let moderate_tools = [
            "write_file", "edit_file", "copy_file", "move_file", "mkdir",
            "create_dir", "download_file", "download_image", "http_get",
            "http_post", "http_request", "run_safe_command", "file_compress",
            "file_decompress", "create_project_template", "git_init", "git_clone",
            "git_fetch", "git_pull", "git_stash", "git_tag", "screenshot",
            "take_screenshot", "pdf_create", "pdf_merge", "observability_trace",
        ...
        let low_risk_tools = [
            "run_command", "shell_exec", "exec", "delete_file", "delete_dir",
            "remove_file", "git_push", "git_checkout", "git_commit", "git_add",
            "git_merge", "git_reset", "git_rebase", "ssh_exec", "ssh_connect",
            "network_scan", "port_scan", "kill_process", "stop_process",
        ];
