...
impl HostCommand {
    pub fn parse(value: &str) -> Option<Self> {
        Some(match value {
            ...
            "ollama.models" => Self::OllamaModels,
            ...
            "knowledge_base.state" => Self::KnowledgeBaseState,
            "knowledge_base.upload" => Self::KnowledgeBaseUpload,
            "knowledge_base.search" => Self::KnowledgeBaseSearch,
            "knowledge_base.govern" => Self::KnowledgeBaseGovern,
    ...
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::KnowledgeBaseState => "knowledge_base.state",
            Self::KnowledgeBaseUpload => "knowledge_base.upload",
            Self::KnowledgeBaseSearch => "knowledge_base.search",
            Self::KnowledgeBaseGovern => "knowledge_base.govern",
