...
pub const BRIDGE_PROTOCOL_V1: &str = "tokitai-host-v1";
...
impl HostCommand {
    pub fn parse(value: &str) -> Option<Self> {
        Some(match value {
            ...
            "extensions.list" => Self::ExtensionsList,
    ...
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::ExtensionsList => "extensions.list",
...
mod tests {
    ...
    fn uses_stable_protocol_name() {
        assert_eq!(BRIDGE_PROTOCOL_V1, "tokitai-host-v1");
