...
Atlas uses a Wry/WebView2 desktop shell. The UI remains regular frontend code and the Rust host remains modular, so new IDE capabilities can continue to be added without changing the distribution model.
